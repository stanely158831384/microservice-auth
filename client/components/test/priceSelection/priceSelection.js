                    ...
                    >
                        <div className="flex flex-col bg-racoonBlueA rounded-xl text-white">
                            <div className="flex flex-col p-8 mx-3 mt-3 rounded-t-xl bg-racoonBlueB">
                                ...
                                <h2 className="mt-10 font-serif text-5xl text-center">Smart floodlights * 2</h2>
                            ...
                            <div className="flex flex-col p-8 mx-3 mb-3 rounded-b-xl bg-racoonBlueB">
                                <div className="flex flex-col space-y-2">
                                    ...
                                    <div className="flex justify-center">
                                        ...
                                        <span className="text-sm ml-1">1080p event or continuous recording</span>
                                    </div>
                                    ...
                                    <div className="flex justify-center">
                                        ...
                                        <span className="text-sm ml-1">32GB local storage, up to 3.5 days of video back-up</span>
                                    </div>
                                    ...
                                    <div className="flex justify-center">
                                        ...
                                        <span className="text-sm ml-1">low temp and waterproof (ip65 waterproof and outdoor-ready (-5 F to 133 F))</span>
                                    </div>
                                    ...
                                    <div className="flex justify-center">
                                        ...
                                        <span className="text-sm ml-1">more dangers detection features (extra cost may apply)</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col bg-racoonBlueA rounded-xl text-white">
                            <div className="flex flex-col p-8 mx-3 mt-3 rounded-t-xl bg-racoonBlueB">
                                ...
                                <h2 className="mt-10 font-serif text-5xl text-center">Basic + 2 extra cameras</h2>
                        ...
                        <div className="flex flex-col bg-racoonBlueA rounded-xl text-white">
                            <div className="flex flex-col p-8 mx-3 mt-3 rounded-t-xl bg-racoonBlueB">
                                ...
                                <h2 className="mt-10 font-serif text-5xl text-center">Advanced + doorbell</h2>
                            ...
                            <div className="flex flex-col flex-1 p-8 mx-3 mb-3 rounded-b-xl bg-racoonBlueB ">
                                <div className="flex flex-col space-y-2">
                                    ...
                                    <div className="flex justify-center">
                                        ...
                                        <span className="text-sm ml-1">Received a call on your phone when a visitor clicks the doorbell multiple times</span>
                                    </div>

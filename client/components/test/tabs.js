            ...
            >
              <li className="-mb-px mr-2 last:mr-0 flex-auto text-center">
                <a
                  className={
                    ...
                    (openTab === 1 ? " border-b-4 border-red-500" : " ")
                  }
                  onClick={(e) => {
                    e.preventDefault();
                    setOpenTab(1);
              ...
              <li className="-mb-px mr-2 last:mr-0 flex-auto text-center">
                <a
                  className={
                    "text-3xl font-cyberFonts font-bold uppercase px-5 py-3 rounded block leading-normal text-black" +
                    (openTab === 2 ? " border-b-4 border-red-500" : " ")
                  }
                  onClick={(e) => {
                    e.preventDefault();
                    setOpenTab(2);
              ...
              <li className="-mb-px mr-2 last:mr-0 flex-auto text-center">
                <a
                  className={
                    "text-3xl font-cyberFonts font-bold uppercase px-5 py-3 rounded block leading-normal text-black" +
                    (openTab === 3 ? " border-b-4 border-red-500" : " ")
                  }
                  onClick={(e) => {
                    e.preventDefault();
                    setOpenTab(3);
                ...
                <div className="tab-content tab-space">
                  ...
                  >
                    ...
                    <div className="flex flex-col space-y-8 md:w-1/2">
                      <h3 className="mt-32 text-3xl font-semibold text-center md:mt-0 md:text-left font-cyberFonts">
                        Website design
                      </h3>
                      <p className="max-w-md text-center text-grayishBlue md:text-left">
                        Our website development service can provide the tiny and
                        medium level website development solutions for our
                        business partners.
                      </p>
                  ...
                  >
                    ...
                    <div className="flex flex-col space-y-8 md:w-1/2">
                      ...
                      <p className="max-w-md text-center text-grayishBlue md:text-left">
                        Our smart camera business focuses on the small toronto
                        household, and focuses on the easy installation.
                      </p>
                      <div className="mx-auto md:mx-0">
                        <a
                          href="#"
                  ...
                  >
                    ...
                    <div className="flex flex-col space-y-8 md:w-1/2">
                      ...
                      <p className="max-w-md text-center text-grayishBlue md:text-left">
                        Seneca forum is an experiment project, this project was
                        applied the latest and the most commonest technologies
                        into it. The primary purpose of this project is going to
                        increase our technical reserve.
                      </p>
                      <div className="mx-auto md:mx-0">
                        <a
                          href="#"

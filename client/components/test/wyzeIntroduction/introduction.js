            ...
            <div className="flex relative flex-col rounded-3xl m-10 shadow-xl min-h-fit	" style={styles.introductionBackground}>
                ...
                <div className="flex sm:flex-row-reverse flex-col m-5">
                    ...
                    <div className="flex-col rounded-3xl sm:w-1/3 w-full infos-2 shadow-xl">
                        ...
                        <p className="m-5">Wyze is an smart home company, who provides various of products like Smart cameras, thermal monitors, smart lighting equipments, and etc. </p>
                        <p className="m-5">The reason why we use Wyze is because their products are really good performance and affordable comparing other candidates, like google and amazon</p>
                        <p className="m-5">" Wyze offers smart home cameras and devices packed with features at a price that is accessible for all "</p>

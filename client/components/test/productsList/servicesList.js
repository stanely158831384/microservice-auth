  ...
  return (
    <div ref={catMenu} className="relative">
      <a
        ...
        className="font-cyberFonts tracking-widest hover:text-softRed md:text-cyan-500"
      >
        Home security
      </a>
      {open && (
        <div>
          <div className="absolute left-0 z-20 w-56 py-2 mt-2 overflow-hidden bg-white rounded-md shadow-xl dark:bg-gray-800">
            <Link href="/common/cameraSecurity">

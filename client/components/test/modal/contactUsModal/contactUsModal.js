      ...
      {open && (
        <>
          <Modal
            ...
            style={customStyles}
          >
            <h2 className="font-bold text-2xl text-center m-2">
              Here is the process for ordering the installation
            </h2>
            ...
            <div className="m-10">
              <Tabs.Group aria-label="Pills" style="pills" className="mx-auto">
                <Tabs.Item active={true} title="Step 1">
                  1.Please contact us by this number: +1(647)856-9355.
                  <br />
                  or
                  <br />
                  1.Please contact us by this email:
                  racoonrepubliccanada@gmail.com
                </Tabs.Item>
                <Tabs.Item title="Step 2">
                  2.Once the installation is scheduled, we will send one of our
                  technician to your location.
                </Tabs.Item>
                <Tabs.Item title="Step 3">
                  3.After a full review of your property, we will give your a
                  quotation list.
                </Tabs.Item>
                <Tabs.Item title="Step 4">
                  4.Once the client accepts the quote, our customer service will
                  schedule the installation time. Usually the date of
                  installation will be scheduled within 7 business days.
                </Tabs.Item>
              </Tabs.Group>
            </div>
